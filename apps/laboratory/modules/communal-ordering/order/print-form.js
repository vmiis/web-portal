...
m.get_pdf=function(txt,callback){
    $('#_g_canvas').html(txt);
    var CH=document.getElementById('_g_canvas').clientHeight;
    var CW=document.getElementById('_g_canvas').clientWidth;
    html2canvas(document.querySelector('#_g_canvas')).then(function(canvas){
