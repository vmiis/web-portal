...
(function(){
    ...
    var invoice_client_table="client-wappsystem";
    var invoice_record_table="invoice-wappsystem";
    var invoice_print_module="invoice-print-wapp";
    ...
    m[p+"invoice-print-wapp"]=             {url:H+"/invoice/form.print_and_pdf.wapp.html"};
    //-------------------------------------------------------------------------------------
})();
